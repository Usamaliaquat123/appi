  ...
  return (
    <div className="containerSLideOneCh">
      <div className='container-fluid'>
        ...
        <p className="descTextCh">
          Illiteracy and sub-standard education for the rural masses is recognised
          as the root cause Pakistan's major problems. Social and sectarian
          tensions and widespread pockets of poverty can often be directly
          traced back to outmoded and inadequate education
        </p>
        <p className="descTextCh">
          The primary aim of KEF is to make the highest quality education
          accessible to talented boys and girls from underprivileged and marginalised sections of society, with special emphasis
          on female education
        </p>
      </div>
          </div>
